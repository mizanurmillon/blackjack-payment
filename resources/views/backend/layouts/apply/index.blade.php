                        ...
                        <table id="data-table" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Accept Credit Cards</th>
                                    <th>Website</th>
                                    <th>Do you have a website?</th>
                                    <th>Country</th>
                                    <th>Receive a Call?</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.apply_user.index') }}",
                        type: "get",
                    },
        ...
        function deleteItem(id) {
            let url = "{{ route('admin.apply_user.destroy', ':id') }}";
