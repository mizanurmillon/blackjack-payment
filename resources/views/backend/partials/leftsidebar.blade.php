    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="{{ request()->routeIs('admin.contact_us.*') ? 'mm-active' : '' }}">
                ...
                <li class="{{ request()->routeIs(['admin.apply_user.*']) ? 'mm-active' : '' }}">
                    <a href="{{ route('admin.apply_user.index') }}" class="waves-effect">
                        ...
                        <span key="t-file-manager">Apply User</span>
                    </a>
                </li>
